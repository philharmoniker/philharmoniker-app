var addToHome=function(b){function p(){b.removeEventListener("load",p,!1);q?c.expire&&t&&b.localStorage.setItem("addToHome",Date.now()+6E4*c.expire):b.localStorage.setItem("addToHome",Date.now());if(x||y&&t&&!u&&!z&&q){var d="",r=e.platform.split(" ")[0],k=e.language.replace("-","_");a=document.createElement("div");a.id="addToHomeScreen";a.style.cssText+="left:-9999px;-webkit-transition-property:-webkit-transform,opacity;-webkit-transition-duration:0;-webkit-transform:translate3d(0,0,0);position:"+
(5>f?"absolute":"fixed");c.message in s&&(k=c.message,c.message="");""===c.message&&(c.message=k in s?s[k]:s.en_us);c.touchIcon&&(d=A?document.querySelector('head link[rel^=apple-touch-icon][sizes="114x114"],head link[rel^=apple-touch-icon][sizes="144x144"],head link[rel^=apple-touch-icon]'):document.querySelector('head link[rel^=apple-touch-icon][sizes="57x57"],head link[rel^=apple-touch-icon]'))&&(d='<span style="background-image:url('+d.href+')" class="addToHomeTouchIcon"></span>');a.className=
(h?"addToHomeIpad":"addToHomeIphone")+(d?" addToHomeWide":"");a.innerHTML=d+c.message.replace("%device",r).replace("%icon",4.2<=f?'<span class="addToHomeShare"></span>':'<span class="addToHomePlus">+</span>')+(c.arrow?'<span class="addToHomeArrow"></span>':"")+(c.closeButton?'<span class="addToHomeClose">\u00d7</span>':"");document.body.appendChild(a);c.closeButton&&a.addEventListener("click",B,!1);!h&&6<=f&&window.addEventListener("orientationchange",C,!1);setTimeout(F,c.startDelay)}}function F(){var d;
d=208;if(h)switch(5>f?(g=b.scrollY,l=b.scrollX):6>f&&(d=160),a.style.top=g+c.bottomOffset+"px",a.style.left=l+d-Math.round(a.offsetWidth/2)+"px",c.animationIn){case "drop":d="0.6s";a.style.webkitTransform="translate3d(0,"+-(b.scrollY+c.bottomOffset+a.offsetHeight)+"px,0)";break;case "bubble":d="0.6s";a.style.opacity="0";a.style.webkitTransform="translate3d(0,"+(g+50)+"px,0)";break;default:d="1s",a.style.opacity="0"}else switch(g=b.innerHeight+b.scrollY,5>f?(l=Math.round((b.innerWidth-a.offsetWidth)/
...
d;a.style.opacity="1";a.style.webkitTransform="translate3d(0,0,0)";a.addEventListener("webkitTransitionEnd",v,!1);n=setTimeout(w,c.lifespan)}function w(){clearInterval(D);clearTimeout(n);n=null;if(a){var d=0,r=0,k="1",e="0";c.closeButton&&a.removeEventListener("click",B,!1);!h&&6<=f&&window.removeEventListener("orientationchange",C,!1);5>f&&(d=h?b.scrollY-g:b.scrollY+b.innerHeight-g,r=h?b.scrollX-l:b.scrollX+Math.round((b.innerWidth-a.offsetWidth)/2)-l);a.style.webkitTransitionProperty="-webkit-transform,opacity";
switch(c.animationOut){case "drop":h?(e="0.4s",k="0",d+=50):(e="0.6s",d+=a.offsetHeight+c.bottomOffset+50);break;case "bubble":h?(e="0.8s",d-=a.offsetHeight+c.bottomOffset+50):(e="0.4s",k="0",d-=50);break;default:e="0.8s",k="0"}a.addEventListener("webkitTransitionEnd",v,!1);a.style.opacity=k;a.style.webkitTransitionDuration=e;a.style.webkitTransform="translate3d("+r+"px,"+d+"px,0)"}}function B(){b.sessionStorage.setItem("addToHomeSession","1");u=!0;w()}function v(){a.removeEventListener("webkitTransitionEnd",
v,!1);a.style.webkitTransitionProperty="-webkit-transform";a.style.webkitTransitionDuration="0.2s";n?5>f&&n&&(D=setInterval(G,c.iterations)):(a.parentNode.removeChild(a),a=null)}function G(){var d=new WebKitCSSMatrix(b.getComputedStyle(a,null).webkitTransform),c=h?b.scrollY-g:b.scrollY+b.innerHeight-g,e=h?b.scrollX-l:b.scrollX+Math.round((b.innerWidth-a.offsetWidth)/2)-l;c==d.m42&&e==d.m41||(a.style.webkitTransform="translate3d("+e+"px,"+c+"px,0)")}function C(){a.style.marginLeft=-Math.round(a.offsetWidth/
2)-(b.orientation%180&&6<=f?40:0)+"px"}var e=b.navigator,E="platform"in e&&/iphone|ipod|ipad/gi.test(e.platform),h,A,y,z,f,l=0,g=0,m=0,t,u,q,a,x,D,n,c={autostart:!0,returningVisitor:!1,animationIn:"drop",animationOut:"fade",startDelay:2E3,lifespan:15E3,bottomOffset:14,expire:0,message:"",touchIcon:!0,arrow:!0,hookOnLoad:!0,closeButton:!0,iterations:100},s={ar:'<span dir="rtl">\u0642\u0645 \u0628\u062a\u062b\u0628\u064a\u062a \u0647\u0630\u0627 \u0627\u0644\u062a\u0637\u0628\u064a\u0642 \u0639\u0644\u0649 <span dir="ltr">%device:</span>\u0627\u0646\u0642\u0631<span dir="ltr">%icon</span> \u060c<strong>\u062b\u0645 \u0627\u0636\u0641\u0647 \u0627\u0644\u0649 \u0627\u0644\u0634\u0627\u0634\u0629 \u0627\u0644\u0631\u0626\u064a\u0633\u064a\u0629.</strong></span>',
...
zh_cn:"\u60a8\u53ef\u4ee5\u5c06\u6b64\u5e94\u7528\u7a0b\u5f0f\u5b89\u88c5\u5230\u60a8\u7684 %device \u4e0a\u3002\u8bf7\u6309 %icon \u7136\u540e\u70b9\u9009<strong>\u6dfb\u52a0\u81f3\u4e3b\u5c4f\u5e55</strong>\u3002",zh_tw:"\u60a8\u53ef\u4ee5\u5c07\u6b64\u61c9\u7528\u7a0b\u5f0f\u5b89\u88dd\u5230\u60a8\u7684 %device \u4e0a\u3002\u8acb\u6309 %icon \u7136\u5f8c\u9ede\u9078<strong>\u52a0\u5165\u4e3b\u756b\u9762\u87a2\u5e55</strong>\u3002"};(function(){if(E){var a=Date.now(),g;if(b.addToHomeConfig)for(g in b.addToHomeConfig)c[g]=
b.addToHomeConfig[g];c.autostart||(c.hookOnLoad=!1);h=/ipad/gi.test(e.platform);A=b.devicePixelRatio&&1<b.devicePixelRatio;y=/Safari/i.test(e.appVersion)&&!/CriOS/i.test(e.appVersion);z=e.standalone;f=(f=e.appVersion.match(/OS (\d+_\d+)/i))&&f[1]?+f[1].replace("_","."):0;m=+b.localStorage.getItem("addToHome");u=b.sessionStorage.getItem("addToHomeSession");q=c.returningVisitor?m&&m+24192E5>a:!0;m||(m=a);t=q&&m<=a;c.hookOnLoad?b.addEventListener("load",p,!1):!c.hookOnLoad&&c.autostart&&p()}})();return{show:function(b){E&&
!a&&(x=b,p())},close:w,reset:function(){b.localStorage.removeItem("addToHome");b.sessionStorage.removeItem("addToHomeSession")}}}(window);
